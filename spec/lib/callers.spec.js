import MockedComponent from "../__mocks__/MockedComponent.svelte";
import {
  alert,
  confirm,
  modal,
...
describe("callers", () => {
  ...
  describe("prompt", () => {
    ...
    it("should map multiple inputs to array", () => {
      ...
      expect(getInputsWithProps).toHaveBeenCalledTimes(1);
      expect(getInputsWithProps).toHaveBeenCalledWith([input, input], {
        props,
      });
    ...
    it("should use additional options", () => {
      ...
      expect(getInputsWithProps).toHaveBeenCalledTimes(1);
      expect(getInputsWithProps).toHaveBeenCalledWith([input], {
        props,
        input,
      });
