...
describe("DialogContent", () => {
  ...
  it("should render custom slots", async () => {
    ...
    const customHeader = queryByTestId(
      "dialog-content-custom-slots-fixture__header"
    );
    const customBody = queryByTestId(
      "dialog-content-custom-slots-fixture__body"
    );
    const customFooter = queryByTestId(
      "dialog-content-custom-slots-fixture__footer"
    );
