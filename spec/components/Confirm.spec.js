...
describe("Confirm", () => {
  ...
  it("should render with right options", async () => {
    ...
    expect(declineButton).toHaveTextContent(
      defaultConfirmOptions.declineButtonText
    );
    ...
    expect(confirmButton).toHaveTextContent(
      defaultConfirmOptions.confirmButtonText
    );
  });

  it("should render with html string confirm and decline buttons text", async () => {
    const confirmButtonText =
      '<p data-testid="test-confirm-button-text">test string</p>';
    const declineButtonText =
      '<p data-testid="test-decline-button-text">test string</p>';
