 ...
 * @returns {any} - the property stored in context
 ...
 * @param {function} close - the close function to store in context
 * @returns {function} - the close function stored in context
 */
 ...
 * @param {object} opts - the options object to store in context
 * @returns {object} - the options object stored in context
 */
