...
export class DialogContent extends SvelteComponent<
  {},
  {},
  { header: {}; body: {}; footer: {} }
> {}
...
export class Confirm extends SvelteComponent<{}, {}, {}> {}

export class Prompt extends SvelteComponent<{ inputs?: Array<ComponentAndProps> }, {}, {}> {}

export class DialogInput extends SvelteComponent<
  {
    value?: any;
    label?: string;
    id?: string;
